...
//            Why using max frame...
//            it will be usefull to fit the conected to small iphones later...
        }
        .padding()
...
//        Since the them is black...
//         using alwais dark mode...
...
//                Globe At Bottom....
            Image("globe")
                ...
                .scaleEffect(1.5)
                .offset(y:getRect().height < 750 ? getRect().height  : getRect().height - 40)
...
//                Scaling Down image and showing Status...
    ...
    //        Max Frame...
        ...
        //                toling shadow when button is cliccked...
